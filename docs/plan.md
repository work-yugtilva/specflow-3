...
**Verify:** V + **Playwright MCP** drives magic-link flow against local Supabase inbucket, invite accept both roles, SAML config smoke (IdP-initiated stub).
